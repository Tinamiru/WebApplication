...
public class MybastisSqlSessionFactory implements SqlSessionFactory {

	private SqlSessionFactory sqlSessionFactory;

	{
		String config = "com/jr/mybatis/config/sqlConfig.xml";
		...
		try {
			...
			System.out.println("sqlSessionFactory has connected");

		} catch (Exception e) {
			System.out.println("sqlSessionFactory connect fail");
			e.printStackTrace();
		}
	}
