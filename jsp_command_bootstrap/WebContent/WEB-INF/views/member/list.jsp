   				...
   				<div id="keyword" class="card-tools" style="width:550px;">
   					 <div class="input-group row">
					 	...
					 	<select class="form-control col-md-3" name="searchType" id="searchType">
							...
							<option value="i" ${param.search == 'i' ? 'selected' : '' }>아이디</option>
							<option value="n" ${param.search == 'n' ? 'selected' : '' }>이 름</option>
							<option value="p" ${param.search == 'p' ? 'selected' : '' }>전화번호</option>
							<option value="e" ${param.search == 'e' ? 'selected' : '' }>이메일</option>	
