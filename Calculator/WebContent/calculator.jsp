...
<body>
	...
	<div>
		<form action="calculator" method="post" id="form">
			<input type="hidden" name="firstNum" id="first"
				value="<%out.print(request.getAttribute("result"));%>" /> <input
				type="hidden" name="operator" id="opper"
				value="<%out.print(request.getAttribute("operator"));%>" /> <input
				type="hidden" name="secondNum" id="second" /> <input type="hidden"
				name="secondOpper" id="secondOpper"
				value="<%out.print(request.getAttribute("secondOpper"));%>" />
		</form>
	</div>
	<script>
